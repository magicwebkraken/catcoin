    ...
    function f(e, r) {
      if (e.dev)
        switch (r.type) {
          ...
          case "request":
            var t;
            return null == (t = r.cookies.get(u.NEXT_HMR_REFRESH_HASH_COOKIE))
              ? void 0
              : t.value;
        }
    }
  ...
  (e, r, t) => {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      Object.defineProperty(t, "unstable_rethrow", {
        ...
        get: function () {
          return function e(r) {
            if ((0, a.isNextRouterError)(r) || (0, n.isBailoutToCSRError)(r))
              throw r;
        ...
        switch (t.type) {
          ...
          case "prerender": {
            ...
            n &&
              n.size > 0 &&
              i.default.use(
                (0, f.makeHangingPromise)(t.renderSignal, r.route, e)
              );
            break;
          }
          case "prerender-ppr": {
